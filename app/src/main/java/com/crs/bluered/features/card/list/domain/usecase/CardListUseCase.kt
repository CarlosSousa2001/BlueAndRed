...
interface CardListUseCase {
    operator fun invoke(parameters: CardListUseCase.Parameters): Flow<ResponseData<PaginatedResponse<CardOptionsResponseEntity>>>
...
class CardListUseCaseImpl @Inject constructor(
    ...
    override fun invoke(parameters: CardListUseCase.Parameters): Flow<ResponseData<PaginatedResponse<CardOptionsResponseEntity>>> {
        return flow {
